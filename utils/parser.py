...
def get_args():
    ...
    parser.add_argument('--category', type = str, default='chair', help = 'chair or plane or table')
    parser.add_argument(
        '--resume', 
        action='store_true', 
        default=False, 
    ...
    args.ae_p = "./pretrained/AE_P.pth"
    args.ae_C = "./pretrained/AE_C.pth"
    args.cov = "./pretrained/cov.pth"

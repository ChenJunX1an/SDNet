...
class PCTransformer(nn.Module):
    ...
    def __init__(self, in_chans=3, embed_dim=768, depth=[6, 6], num_heads=4, mlp_ratio=2., qkv_bias=False,
    ...
    def forward(self, coor,f):
        ...
        '''
        # build point proxy
        #coor: B 3 N(128)  f,pos,x:B N(128) C(384)
        bs = coor.size(0)
        ...
        return q, coarse_point_cloud  #coor:B N(128) 3